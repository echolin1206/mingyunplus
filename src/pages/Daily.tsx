...
import { Check, X, Clock, Sunrise, Sunset, Moon, Sun, Star, ChevronLeft, ChevronRight, Palette, Shirt, Sparkles } from 'lucide-react';
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 space-y-3">
              ...
              <div className="flex items-start gap-2">
                <Shirt className="w-4 h-4 text-[#efb6ff] flex-shrink-0 mt-0.5" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="liquid-glass rounded-2xl p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-xl font-bold text-[#00c896]">今日宜</h3>
              </div>
            ...
            <div className="liquid-glass rounded-2xl p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-xl font-bold text-[#ff6464]">今日忌</h3>
              </div>
              <div className="flex flex-wrap gap-2">
                {data.ji.map((item, i) => (
                  <span
            ...
            {/* Extra tips */}
            <div className="md:col-span-2 liquid-glass rounded-2xl p-6">
              <h3 className="text-lg font-bold text-[#f6f9ff] mb-3 flex items-center gap-2">
                <Moon className="w-5 h-5 text-[#efb6ff]" />
                今日寄语
              </h3>
              <p className="text-[rgba(246,249,255,0.7)] leading-relaxed">
                今日{data.ganZhi}，{data.zhi}日当值。天时地利人和，{data.yi[0]}、{data.yi[1]}之事最为顺遂。
                然需注意冲{data.chong}煞{data.sha}，{data.ji[0]}之事暂且搁置。
                顺应天时者，事半功倍；逆天行事者，徒增烦恼。
                愿你在今日的指引下，步履从容，心如止水。
              </p>
            </div>
          </div>
